...
with(subPower, {
  ...
  plot(subPower$Time,subPower$Voltage, ylab="Voltage", xlab="datetime")
  ...
  plot(subPower$Time,subPower$Global_reactive_power,type="l",xlab="datetime",ylab="Global_rective_power") 
})
dev.off()
